...
public abstract class BaseRtpSocket implements Runnable {
    ...
    public static final int VIDEO_DATA_TYPE = 1001;
    public static final int AUDIO_DATA_TYPE = 1002;
    ...
    protected int sendDataType;
    protected ISocketSendListener socketSendListener;
    ...
    /**
     * #VIDEO_DATA_TYPE, AUDIO_DATA_TYPE
     *
     * @param dataType
     */
    ...
    public void setSocketSendListener(ISocketSendListener socketSendListener) {
        this.socketSendListener = socketSendListener;
    }

    protected void postSendError() {
        if(socketSendListener != null) {
            socketSendListener.onSendError();
        }
    }
    /**
