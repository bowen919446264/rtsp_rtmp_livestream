...
public class MagicHealthyFilter extends GPUImageFilter {
    ...
    public MagicHealthyFilter(Context context) {
        super(NO_FILTER_VERTEX_SHADER, RecordUtils.readShaderFromRawResource(context, R.raw.healthy));
        mContext = context;
    }
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = RecordUtils.loadTexture(mContext, "filter/healthy_mask_1.jpg");
            }
        });
    }
