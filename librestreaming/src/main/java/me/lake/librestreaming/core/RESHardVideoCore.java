...
public class RESHardVideoCore implements RESVideoCore {
    ...
    private IRtspSender videoRtspSender;
    ...
    public boolean prepare(RESConfig resConfig) {
        synchronized (syncOp) {
            ...
            videoGLHander.setVideoRtspSender(videoRtspSender);
    ...
    @Override
    public void setVideoRtspSender(IRtspSender videoRtspSender) {
        this.videoRtspSender = videoRtspSender;
        if(videoGLHander != null) {
            videoGLHander.setVideoRtspSender(videoRtspSender);
        }
    }
    ...
    private class VideoGLHandler extends Handler {
        ...
        public void setVideoRtspSender(IRtspSender videoRtspSender) {
            ...
            if(videoSenderThread != null) {
                videoSenderThread.setVideoRtspSender(videoRtspSender);
            }
        }
